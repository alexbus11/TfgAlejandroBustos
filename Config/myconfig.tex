...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author data
\newcommand{\myAuthorName}{Alejandro}
\newcommand{\myAuthorSurname}{Bustos Sánchez}
\newcommand{\myAuthorFullName}{\myAuthorName{} \myAuthorSurname{}}
\newcommand{\myAuthorGender}{male} 
\newcommand{\myAuthorEmail}{alejandro.bustoss@edu.uah.es}
\newcommand{\myAuthorDNI}{06329573-L}
% Personal details for the anteproyecto request, not required in some cases
\newcommand{\myAuthorStreet}{C/ Calle Miguel Ángel Asturias , 1}
\newcommand{\myAuthorCity}{Madrid}
\newcommand{\myAuthorPostalCode}{28050}
\newcommand{\myAuthorProvince}{Madrid}
\newcommand{\myAuthorTelephone}{685868466}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calendar dates 
\newcommand{\myThesisProposalDate}{16 de enero de 2026} % "Anteproyecto" date

\newcommand{\myThesisDepositDate}{15 de junio de 2026}
